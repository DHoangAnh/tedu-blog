...
@Component({
    ...
    standalone: true,
    imports: [CheckboxModule, BlockUIModule, ProgressSpinnerModule, PanelModule, TeduSharedModule, KeyFilterModule, ReactiveFormsModule, FormsModule, FormModule, InputTextModule, ButtonModule]
})
