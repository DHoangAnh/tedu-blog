...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, TableModule, ProgressSpinnerModule, BlockUIModule, PaginatorModule, PanelModule, CheckboxModule, SharedModule, ButtonModule, InputTextModule]
})
